...
function CouponCard({ name, validUntil, discount, logo }) {
  return (
    <div className="relative flex min-h-[104px] w-[345px] cursor-pointer flex-col items-center gap-4 rounded-[8px] border border-neutral-700 bg-white px-4 py-4 shadow-xl">
